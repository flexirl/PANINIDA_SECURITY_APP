-- ============================================================
-- PAN INDIA SECURITY — Attendance System Fix
-- Migration 031: Fix Replacement Trigger RLS Issue
--
-- Adds SECURITY DEFINER to the auto_create_replacement_on_absent
-- function so that when a guard checks out and is marked absent,
-- the trigger can insert into the `replacements` table bypassing RLS.
-- ============================================================
