...
const targetPath = path.join('c:', 'Users', 'KIIT', 'Desktop', 'PAN_INDIA_SECURITY', 'mobile', 'src', 'screens', 'SalarySlipDetailScreen.tsx');
          ...
          <View style={s.detailBody}>
            ...
            <View style={s.detailRow}>
              <View>
                ...
                <Text style={s.detailRowSub}>{data.overtimeHours} Hours @ ₹{data.overtimeRate}/hr</Text>
              </View>
...
console.log('Successfully updated SalarySlipDetailScreen.tsx');
